...
RUN install-repository \
    ...
    "--url http://toolshed.g2.bx.psu.edu/ -o galaxyp --name clustalomega --panel-section-name SequenceClustering" \
    "--url http://toolshed.g2.bx.psu.edu/ -o galaxyp --name clustalw --panel-section-name SequenceClustering"
